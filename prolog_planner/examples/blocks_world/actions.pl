...
action(
  ...
  [available(Agent), on(Block1, Block2), at(Block2, X1, Y1), clear(Block1)],
  ...
  [
    ...
    add(moving_onblock_to_table(Agent, Block1, Block2, X1, Y1, X2, Y2)), add(clear(Block2))
  ]
).
action(
...
action(
  ...
  [],
  [pos(X1, Y1), pos(X2, Y2), block(Block1), block(Block2), block(Block3), Block1 \= Block2, Block1 \= Block3, Block2 \= Block3],
  [

...
THE_FILE_PATH=os.path.join("output", "the_file.pl") 
...
def parse_file(parent_file, G, path, the_file=os.path.join("output", "the_file.pl")):
...
if __name__ == "__main__":
    path = os.path.dirname(THE_FILE_PATH)
    os.makedirs(path, exist_ok=True)
    with open(THE_FILE_PATH, "w") as file:
        file.write(f"% This file was automatically generated by the {os.path.basename(__file__)} script %\n\n")
